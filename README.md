...
After running ```preprocess.py``` you'll get the results: 1. Reference, 2. Mask, 3. Driving image, 4. Landmark, 5. Shading hints 
...
After running ```inference.py``` you'll get the results: 1. Reference, 2. Shading hints, 3. Relighting result, 4. Driving image
