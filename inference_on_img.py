...
class RelightablePA():
    ...
    def portrait_animation_and_relighting(self, image_path, save_path, guidance, inference_steps, driving_mode="relighting"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--image_path", type=str, default="resources/shading.mp4", help="reference and shading") 
    ...
    relightablepa.portrait_animation_and_relighting(image_path=args.image_path, 
